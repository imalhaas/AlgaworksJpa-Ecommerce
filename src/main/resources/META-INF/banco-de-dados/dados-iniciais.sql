...
insert into Produto (id, nome, preco, descricao) values (3, 'Camera GoPro Hero 7', 1400.0, 'Desempenho 2x mais nas suas fotos e videos');

insert into CLiente (id, nome) values (1, 'Beta');
insert into CLiente (id, nome) values (2, 'Neves');